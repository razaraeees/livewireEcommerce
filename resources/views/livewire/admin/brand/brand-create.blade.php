                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 mb-8 mb-sm-0">
                            <h2 class="fs-4 mb-0">Add New Brand</h2>
                        </div>
                            ...
                            <div class="card mb-8 rounded-4">
                                ...
                                <div class="card-body p-7">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-8">
                                                <label class="mb-4 fs-13px ls-1 fw-bold text-uppercase">Brand
                                                    Name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-8">
                                                ...
                                                @error('slug')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <small class="text-muted">Slug will be auto-generated from brand
                                                    name</small>
                                            </div>
                                        </div>
