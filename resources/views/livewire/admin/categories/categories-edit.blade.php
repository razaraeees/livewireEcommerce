...
}" x-init="name = '{{ $category_name }}'; slug = '{{ $url }}'; $watch('name', value => value && generateSlug())">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 mb-8 mb-sm-0">
                            <h2 class="fs-4 mb-0">Edit Category</h2>
                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-8">
                                                ...
                                                <select wire:model.live="level" class="form-control" required>
                                                    ...
                                                    <option value="0">Main Category (Level 1)</option>
                                                    <option value="1">Sub Category (Level 2)</option>
                                                    <option value="2">Sub-Sub Category (Level 3)</option>
                                                </select>
                                                @error('level')
                                                ...
                                                <small class="text-muted d-block mt-2">
                                                    ...
                                                    @elseif($level == 1) 
                                                        This will be under a main category (Level 2)
                                                    @elseif($level == 2) 
                                                        This will be under a sub category (Level 3)
                                                    @else 
                                            ...
                                            <div class="mb-8">
                                                ...
                                                @if($level == 1 && count($mainCategories) == 0)
                                                    <small class="text-warning d-block mt-2">
                                                        <i class="far fa-exclamation-triangle"></i> No main categories available. Create a main category first.
                                                    </small>
                                                @elseif($level == 2 && count($subCategories) == 0)
                                                    <small class="text-warning d-block mt-2">
                                                        <i class="far fa-exclamation-triangle"></i> No sub categories available. Create a sub category first.
                                                    </small>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="card-body p-7">
                                    <div class="input-upload text-center position-relative">
                                        ...
                                        @elseif($existing_image)
                                            {{-- EXISTING IMAGE --}}
                                            <div class="position-relative">
                                                <img src="{{ asset('storage/' . $existing_image) }}" class="w-100 rounded mb-4" style="max-height: 250px; object-fit: cover;">
                                                <button type="button" wire:click="deleteExistingImage"
                                                    class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2"
                                                    wire:confirm="Are you sure you want to delete this image?">&times;</button>
                                            </div>
                                        @else
                                            {{-- NO IMAGE --}}
                                ...
                                <div class="card-body p-7">
                                    <div class="input-upload text-center position-relative">
                                        ...
                                        @elseif($existing_banner)
                                            {{-- EXISTING BANNER --}}
                                            <div class="position-relative">
                                                <img src="{{ asset('storage/' . $existing_banner) }}" class="w-100 rounded mb-4" style="max-height: 250px; object-fit: cover;">
                                                <button type="button" wire:click="deleteExistingBanner"
                                                    class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2"
                                                    wire:confirm="Are you sure you want to delete this banner?">&times;</button>
                                            </div>
                                        @else
                                            {{-- NO BANNER --}}
                                            <img src="{{ asset('assets/images/dashboard/upload.svg') }}" width="102"
                                    ...
                                    <div class="mt-4">
                                        <label class="form-check">
                                            <input class="form-check-input" type="checkbox" wire:model="banner_status" {{ $banner_status ? 'checked' : '' }}>
                                            <span class="form-check-label">
