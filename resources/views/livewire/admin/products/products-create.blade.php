                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-8 rounded-4">
                                ...
                                <div class="card-body p-7">
                                    ...
                                    @foreach ($selectedVariants as $index => $selectedVariant)
                                        <div class="card mb-4 border"
                                            wire:key="variant-selection-{{ $index }}">
                                            <div class="card-body p-4">
                                                <div class="row align-items-start">
                                                    <div class="col-md-5">
                                                        <label class="form-label fw-bold">Select Variant Type</label>
                                                        <select wire:model.live="selectedVariants.{{ $index }}"
                                                            class="form-select">
                                                    ...
                                                    <div class="col-md-7">
                                                        @if (!empty($selectedVariants[$index]))
                                                            @php
                                                    ...
                                                    <div class="col-md-1 text-end">
                                                        @if ($index > 0)
                                                            <button type="button"
                                                                wire:click="removeVariantSelection({{ $index }})"
