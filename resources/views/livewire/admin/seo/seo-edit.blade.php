<div x-data="{
    ...
    generateSlug() {
        ...
        // Auto-fill OG URL only if it matches original (optional enhancement)
        if ('{{ $og_url }}' === '{{ url('/') }}/' + this.originalSlug) {
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 mb-8 mb-sm-0">
                            <h2 class="fs-4 mb-0">Edit SEO Page</h2>
                        </div>
                            ...
                            <div class="card mb-8 rounded-4">
                                ...
                                <div class="card-body p-7">
                                    ...
                                    <div class="input-upload text-center position-relative">
                                        @if ($meta_image)
                                            <!-- Newly uploaded image (temporary) -->
                                            <div class="position-relative">
                                                <img src="{{ $meta_image->temporaryUrl() }}" class="w-100 rounded mb-4" alt="New Upload">
                                                <button type="button" wire:click="$set('meta_image', null)"
                                                    class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2">&times;</button>
                                            </div>
                                        @elseif ($existing_image)
                                            <!-- Existing stored image -->
                                            <div class="position-relative">
                                                <img src="{{ asset('storage/' . $existing_image) }}" class="w-100 rounded mb-4" alt="Current Image">
