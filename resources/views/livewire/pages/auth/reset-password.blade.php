...
<div>
    ...
    <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center px-4 py-5 bg-white">
        <div class="w-100" style="max-width: 450px;">
            ...
            <form wire:submit="resetPassword">
                ...
                <button 
                    type="submit" 
                    class="btn btn w-100 text-white"
    ...
    <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center position-relative overflow-hidden" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        
        <!-- Animated Background Particles -->
        <div class="position-absolute w-100 h-100" style="opacity: 0.1;">
            <div class="position-absolute rounded-circle bg-white" style="width: 300px; height: 300px; top: -100px; right: -100px; animation: float 6s ease-in-out infinite;"></div>
            <div class="position-absolute rounded-circle bg-white" style="width: 200px; height: 200px; bottom: -50px; left: -50px; animation: float 8s ease-in-out infinite;"></div>
            <div class="position-absolute rounded-circle bg-white" style="width: 150px; height: 150px; top: 50%; left: 20%; animation: float 7s ease-in-out infinite;"></div>
        </div>
        ...
        <div class="position-relative text-center px-5">
            ...
            <div class="mb-5">
                <div class="d-inline-flex align-items-center justify-content-center position-relative" style="width: 200px; height: 200px;">
                    <!-- Rotating Circle -->
                    <div class="position-absolute border border-white rounded-circle" style="width: 200px; height: 200px; opacity: 0.2; animation: rotate 20s linear infinite;"></div>
                    <div class="position-absolute border border-white rounded-circle" style="width: 160px; height: 160px; opacity: 0.3; animation: rotate 15s linear infinite reverse;"></div>
